    ...
    def __call__(
        ...
        Args:
            ...
            cross_attention_kwargs (`dict`, *optional*):
                A kwargs dictionary that if specified is passed along to the [`AttentionProcessor`] as defined in
                [`self.processor`](https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/attention_processor.py).
            frozen_mask (`torch.FloatTensor or List[torch.FloatTensor]`, *optional*):
                Peekaboo mask to control the attention of the foreground object.
            frozen_steps (`int`, *optional*):
                Number of Peekaboo steps to apply the mask.
            custom_attention_mask (`torch.FloatTensor`, *optional*):
                Custom attention mask to be used for the text encoder. Better to use `fg_prompt` instead.
            latents_all_input (`torch.FloatTensor`, *optional*):
                Pre-generated noisy latents sampled from a Gaussian distribution, to be used as inputs for video generation.
            fg_prompt (`str`, *optional*):
                Forground object from the input prompt to be guided with mask.
